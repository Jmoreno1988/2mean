...
var ThematicService = (function () {
    function ThematicService(_http) {
        this._http = _http;
        this.url = "http://localhost:3688/api";
    }
    ThematicService.prototype.createThematic = function (newThematic) {
        var json = JSON.stringify(newThematic);
        var params = json;
...
//# sourceMappingURL=thematic.services.js.map